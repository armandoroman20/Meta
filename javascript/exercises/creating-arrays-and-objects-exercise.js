...
// Add 5 of your favorite items of clothing as strings using the push() method.
    ...
    clothes.push("New Balance", "Kill Crew Shorts", "Hoochie daddy shorts", "shirts", "pants");
    console.log(clothes);
...
// Using the dot notation, assign a color property to the favCar object 
// and give it a string value with the color of your choice.

favCar.color = "blue";

// Using the dot notation, assign a covertible property to the favCar object 
