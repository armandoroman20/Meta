...
// loop over the bird object's properties 
// and console log each one, using the for...of loop.
// Finally call the function as birdCan() 
// to see the output on the console.Remember,
// you need to console log both the key and 
// the value of each of the bird object's properties.
...
// Step 3. Using the same starter code as in task 2, 
// create a function called `animalCan` and within it,
// loop over all the properties in both the bird object 
// and its prototype - the animal object -
// using the for...in loop. 
// Finally call the function as `animalCan()` 
